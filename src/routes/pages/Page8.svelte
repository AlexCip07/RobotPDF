...
<div class="a4-page">
    ...
    <table class="excel-table" style="width: 100%; margin-bottom: 10px;">
        <tbody>
            <tr>
                ...
                <td style="width: 40%; text-align: center; font-style: italic;">Interverrouillages entre robots</td>
    ...
    <!-- Main interlock table showing robot-to-robot interlocks -->
    <div style="display: flex; justify-content: center; margin-top: 40px;">
        <table class="excel-table" style="width: 700px;">
            ...
            <tbody>
                {#each interlocks.robot as interlock}
                    <tr>
                        <td>Interverrouillage {interlock.number}</td>
                        <td>{interlock.type}</td>
                        <td>{interlock.robot}</td>
                        <td>{interlock.trajectories}</td>
                    </tr>
                {/each}
            </tbody>
        </table>
