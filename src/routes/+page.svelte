    ...
    <div class="a4-page">
        ...
        <div style="display: flex; justify-content: center; margin-top: 40px;">
            <table class="excel-table" style="width: 400px;">
                ...
                <tbody>
                    <tr><td>1</td><td>{motorOffsets[0].masterCount}</td></tr>
                    <tr><td>2</td><td>{motorOffsets[1].masterCount}</td></tr>
                    <tr><td>3</td><td>{motorOffsets[2].masterCount}</td></tr>
                    <tr><td>4</td><td>{motorOffsets[3].masterCount}</td></tr>
                    <tr><td>5</td><td>{motorOffsets[4].masterCount}</td></tr>
                    <tr><td>6</td><td>{motorOffsets[5].masterCount}</td></tr>
                    <tr><td>7</td><td>-</td></tr>
                </tbody>
            </table>
        </div>
